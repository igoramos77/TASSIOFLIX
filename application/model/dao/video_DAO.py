...
class VideoDAO:
    def __init__(self):
        self.videos = [
            ...
            Video(2, 'O Sucessor', '5ª temporada já disponível', 'Drama', '+18', 'Sofrendo de Alzheimer, o chefão do narcotráfico da Galícia anuncia que vai se aposentar e deixar o império para um herdeiro. Isso se o seu braço direito permitir.', 'o-sucessor.mp4', 'bg-sucessor.jpg', 'bg-sucessor2.jpg', '2019', 77, 519),
            Video(3, 'O Atirador', 'O ex-atirador de elite está de volta', 'Ação', '+18', 'Um condecorado atirador de elite da Marinha americana volta à ativa para desmontar uma conspiração com objetivo de matar o presidente, mas acaba acusado de assassinato.', 'o-atirador.mp4', 'bg-atirador.png', 'bg-atirador2.png', '2016', 20, 777777),
            ...
            Video(6, 'Suits', 'Homens de terno', 'Drama Corporativo', '+13', 'Mesmo sem se formar e sem licença para advogar, um jovem brilhante impressiona um importante advogado e consegue uma cobiçada posição em sua firma.', 'suits.mp4', 'bg-suits.jpg', 'bg-suits2.jpg', '2011', 100, 300),
            Video(7, 'Stranger Things', 'A pior série de ficção científica', 'Terror ', '+16', 'Quando um garoto desaparece, a cidade toda participa nas buscas. Mas o que encontram são segredos, forças sobrenaturais e uma menina.', 'stranger-things.mp4', 'bg-stranger.png', 'bg-stranger2.jpg', '2013', 100, 150),
        ]
