...
//share input value current page
var url = window.location.href;
$('.share-input').val(url);
var fbs = document.querySelector('#fbs');

//fbs.href = `https://www.facebook.com/sharer/sharer.php?u=${url}`;


var btnModal = document.querySelectorAll('.share-icon');

btnModal.onclick = function() {
  /* Get the text field */
  var copyGfGText = document.querySelector(".share-input"); 
